...
*/
                ...
                subCategory = 679255011; //roma hombres //2619534011;//PetSupplies, Mascotas
                $scope.itemsTopSellerPetSupplies = [];
                $scope.showTopSellerPetSupplies = false;
                getTenProducts($scope.itemsTopSellerPetSupplies, "Fashion", 679255011, "").then(function success(result) {
                    //console.log('resultresultresultresult',result);
                    //console.log('allProducts',allProducts);
                    /*
                    angular.forEach(result, function (value, key) {
